...
mision:
  ...
  md: |
    ...
    - Hábitat, distribución y movilidad de elasmobranquios costeros, con especial atención al pez guitarra común.
    - Biología y ecología de los peces arrecifales, particularmente enfocada a la conservación de los depredadores apicales.
    - Ecología y monitoreo de Áreas Marinas Protegidas (AMP).
    - Dispersión y movilidad de organismos marinos y conectividad entre poblaciones.
    - Evaluación espacial y temporal de la pesca artesanal y recreativa.
    - Funcionamiento del ecosistema marino, modelización y respuesta del mismo a los cambios globales.
...
grupo:
  actuales:
  - image: grupo/actuales/jose-antonio-garcia-charton.jpg
  ...
  - image: grupo/actuales/maria-pozo-montoro.jpg
    ...
    md: |
      ...
      <details>
        ...
        I have complementarily committed to strengthening my profile as a scientist capable of assisting critical work at sea by becoming a PADI Divemaster with two years of industry experience and a professional seafarer (STWC). I hold a Yatchmaster offshore boating license (Patrón de yate) with sailing attributions, allowing me to commercially take six people up to 5 nautical miles.

        [hide](#)
        {.display-none}
      </details>
  - image: grupo/actuales/amelia-canovas-munoz.jpg
  ...
  - title: Pedro Clemente Navarro Martínez
    subtitle: Doctorando
    md: pedroclemente.navarro@gmail.com 
  - title: Angélica Bas Gómez
    subtitle: Investigadora contratada
    md: angelica.bas@um.es 
  - title: Encarnación Olivares Martínez
    subtitle: Investigadora contratada
  ...
  - title: Adriana Rodríguez Hernández
    md: adrianar@ull.edu.es 
  - title: Amalia Cuadros
    md: amalia.cuadros1@gmail.com 
  - title: Antonio Calò
    md: antonio.calo@unipa.it 
  - title: Antonio Ortolano
    md: antonioortolanomunoz@gmail.com 
  - title: Carlos W. Hackradt
    md: carlos.ufsb@gmail.com 
  - title: Daniel Mateos
    md: dmateos@enwwf.ae 
  - title: Delfine Rocklin 
  - title: Elena Raia
    md: '[+39 329 937 5159](tel:+393299375159)'
  - title: Fabiana C. Félix-Hackradt
    md: fabianacfh@csc.ufsb.edu.br 
  - title: Giulia Lucido
    md: '[+39 334 270 8835](tel:+393342708835)'
  - title: Irene Rojo
    md: irene.rojo@ieo.csic.es 
  - title: Jessica García
    md: jessicagarcia.mpa@gmail.com 
  - title: Jorge Treviño
    md: '[+34 653 15 99 17](tel:+34653159917)'
  - title: José Luis de la Rocha
    md: joseluisla.rochaf@um.es 
  - title: José Manuel Pereñíguez
    md: josemanuel.pereniguez@gmail.com 
  - title: Lucía Verdú
    md: lucia.verdum@um.es 
  - title: María Alcaraz Marín
    md: '[+34 618 43 56 02](tel:+34618435602)'
  - title: María Trujillo
    md: Mariatrujilloieo25@gmail.com 
  - title: Maria Sole Codognotto Capuzzo
    md: msoleccapuzzo@gmail.com 
  - title: Miguel Lorenzi
  - title: Pedro Leitao
    md: pedro.leitao@ipma.pt 
  - title: Ramón Hernández Andreu
    md: ramon.hernandez@ieo.csic.es 
  - title: Riccardo Nanni
    md: rnanni@icm.csic.es 
  - title: Sergio Serretta
    md: '[+39 331 332 3891](tel:+393313323891)'
  - title: Silvia Sánchez Segarra
